...
export default function Images() {
 ...
 dataImages?console.log(dataImages):null
  return (
    <div className="text-orange-100 flex flex-wrap justify-center px-5 gap-5 py-10">
   {  
   imagesTypes ==="0" ?
   dataImages?
   dataImages.backdrops.map((e, i) => {
            return (
              <img
                key={i}
                className="w-[350px] z-10 rounded-2xl border-[3px] border-orange-300 shadow-xl shadow-black/100 "
   ...
   dataImages.logos.map((e, i) => {
    console.log(e.width)
            return (
              ...
              <img
                key={i}
                className={`w-[350px] z-10 p-5 rounded-2xl border-[3px] border-orange-300 shadow-xl shadow-black/100 `}
                src={`https://image.tmdb.org/t/p/w500/${e.file_path}`}
              />
              </section>
            );
